...
// ============================================================
// Fundraising Contract — Contract Methods
// ============================================================

/**
 * Create a new fundraising campaign.
 * Calls: create_campaign(id: u32, owner: Address, goal: i128)
 */
export async function createCampaign(
  ...
  return callContract(
    "create_campaign",
    [toScValU32(id), toScValAddress(caller), toScValI128(goal)],
    caller,
    true
  );
}
 ...
 * Calls: donate(id: u32, donor: Address, amount: i128)
 */
export async function donateToCampaign(
  ...
  return callContract(
    "donate",
    [toScValU32(id), toScValAddress(caller), toScValI128(amount)],
    caller,
    true
  );
}
...
/**
 * Withdraw funds from a campaign (only when goal is reached).
 * Calls: withdraw(id: u32, owner: Address)
 */
 ...
 * Calls: get_campaign(id: u32) -> Campaign
 * Returns: { id, owner, goal, raised, active } or null
 */
